 ...
 *
 * Uses edge flood-fill to identify and remove background pixels while preserving
 * the sticker content and bright white outlines.
 */
...
export function isGrayish(r: number, g: number, b: number, variance: number = 18): boolean {
 ...
 *
 * @param imageBuffer - PNG buffer with potential checkerboard/black background
