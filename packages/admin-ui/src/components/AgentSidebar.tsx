 ...
 */
import { useAgentStore, useActiveAgent } from '../store/agents';
...
export function AgentSidebar({ onConfigureAgent }: AgentSidebarProps) {
      ...
      {activeAgent && (
        <div className="p-3 border-t border-dark-700">
          <button
            ...
            className="w-full flex items-center gap-2 px-3 py-2 rounded-lg bg-dark-800 hover:bg-dark-700 text-dark-300 hover:text-white transition-colors text-sm"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
