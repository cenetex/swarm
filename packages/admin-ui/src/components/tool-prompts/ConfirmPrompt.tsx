  ...
  return (
    <div className={`border rounded-lg p-3 space-y-2 ${
      ...
      <div className="flex items-start gap-2">
        <div className={`p-1.5 rounded-md ${destructive ? 'bg-red-500/20' : 'bg-brand-500/20'}`}>
          <svg className={`w-4 h-4 ${destructive ? 'text-red-400' : 'text-brand-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
        </div>
        <div className="flex-1 min-w-0">
          <h4 className="text-sm font-medium text-[var(--color-text)]">{action}</h4>
          {description && (
