 ...
 * Contains stable resources that rarely change: DynamoDB tables, S3 bucket, CDN, Lambda layer, ECS cluster
 * Deployed first as foundation for other domain stacks
 */
